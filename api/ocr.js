...
export default async function handler(req, res) {
  ...
  const prompt = `이 사진을 보고, 학습자에게 도움이 되는 러시아어 '일반 낱말'(보통명사·동사·형용사 등) 하나를 골라 사전 표제어로 삼아라.
- 사진에 러시아어 일반 낱말이 크게 적혀 있으면: 그 낱말의 사전 원형(기본형)을 표제어로 삼는다(활용형이면 원형으로 되돌린다).
- 상표·제품명·회사명·인명·지명 같은 고유명사만 보이면(라틴 문자든 키릴 문자든): 그것을 표제어로 삼지 말고, 사진 속 실제 사물을 알아본 뒤 그 사물을 가리키는 대표 러시아어 보통명사를 표제어로 삼는다. (예: 오토바이에 "Kawasaki"·"Кавасаки"라고 적혀 있어도 표제어는 상표가 아니라 мотоцикл.)
- 러시아어 글자가 없으면: 사진 속 가장 주요한 사물을 알아보고, 그 사물을 가리키는 대표 러시아어 보통명사를 표제어로 삼는다.
...
{
 "found": true,
 "kind": "text(글자를 읽은 경우) 또는 object(사물을 알아본 경우)",
 "seen": "글자면 사진에서 보인 형태(강세 없이), 사물이면 알아본 대상(한국어로)",
...
낱말을 정할 수 없으면 {"found":false,"msg":"사진에서 낱말을 찾지 못했습니다"}`;
