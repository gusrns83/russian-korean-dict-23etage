...
export default async function handler(req, res) {
  ...
  const prompt = `이 사진을 보고 러시아어 낱말 하나를 골라 사전 표제어로 삼아라.
- 사진에 러시아어 글자가 있으면: 가장 크고 뚜렷한 낱말을 골라 그 사전 원형(기본형)을 표제어로 삼는다(활용형이면 원형으로 되돌린다).
- 러시아어 글자가 없으면: 사진 속 가장 주요한 사물을 알아보고, 그 사물을 가리키는 가장 대표적인 러시아어 낱말을 표제어로 삼는다.
